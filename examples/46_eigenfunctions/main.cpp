...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nMatrix Eigenfunctions" << std::endl;
        std::cout << "====================" << std::endl;
        std::cout << "Usage: eigenfunctions [mesh_file]" << std::endl;
        std::cout << "\nComputes and visualizes Laplacian eigenfunctions on a mesh." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/humanoid.off" << std::endl;
        std::cout << "\nUse GUI to select number of eigenfunctions and which one to display." << std::endl;
        std::cout << "Toggle between cotangent and uniform Laplacian weights." << std::endl;
