...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nPolygon Measures" << std::endl;
        std::cout << "===============" << std::endl;
        std::cout << "Usage: polygon_measures" << std::endl;
        std::cout << "\nDemonstrates polygon geometric measures:" << std::endl;
        std::cout << "  - Polygon kernel (red polygon)" << std::endl;
        std::cout << "  - Smallest enclosing circle (red ring)" << std::endl;
        std::cout << "  - Maximum inscribed circle (blue ring)" << std::endl;
        std::cout << "\nUse the slider to deform the polygon and see measures update in real-time." << std::endl;
