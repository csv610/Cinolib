...
int main(int argc, char **argv)
{
    ...
    if(argc==2 && std::string(argv[1])=="-h")
    {
        std::cout << "\nRemesher" << std::endl;
        std::cout << "=========" << std::endl;
        std::cout << "Usage: remesher [mesh_file]" << std::endl;
        std::cout << "\nInteractive remeshing tool using Botsch-Kobbelt 2004 algorithm." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/pyramid.off" << std::endl;
        std::cout << "\nGUI controls for marking creases, boundaries, and running remesh." << std::endl;
