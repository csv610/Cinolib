...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nTexture Loading" << std::endl;
        std::cout << "===============" << std::endl;
        std::cout << "Usage: texture_loading [mesh_file] [texture_file]" << std::endl;
        std::cout << "\nLoads a mesh and texture, displays two windows: one in object space" << std::endl;
        std::cout << "and one in texture/UV space." << std::endl;
        std::cout << "If no files are provided, defaults to: " << DATA_PATH << "/blub_triangulated.obj" << std::endl;
        std::cout << "and: " << DATA_PATH << "/blub_texture.png" << std::endl;
