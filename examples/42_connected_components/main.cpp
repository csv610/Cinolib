...
int main(int argc, char *argv[])
{
    if(argc==2 && std::string(argv[1])=="-h")
    {
        ...
        std::cout << "====================" << std::endl;
        std::cout << "Usage: connected_components [mesh_file]" << std::endl;
        std::cout << "\nFinds and visualizes connected components in a mesh." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/Gravgen.obj" << std::endl;
        std::cout << "\nEach component is displayed with a different color." << std::endl;
        std::cout << "Press S to save each component to a separate file." << std::endl;
