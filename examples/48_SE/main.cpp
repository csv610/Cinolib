...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nStripe Embedding" << std::endl;
        std::cout << "================" << std::endl;
        std::cout << "Usage: SE [mesh_file] [logfile] [mode]" << std::endl;
        std::cout << "\nStripe Embedding: guaranteed injective mapping to the plane." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/hele_shaw.obj" << std::endl;
        std::cout << "\nBatch mode: provide logfile and mode (1=rationals, 2=MPFR)." << std::endl;
