...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nHermite RBF" << std::endl;
        std::cout << "===========" << std::endl;
        std::cout << "Usage: Hermite_RBF [surface_mesh_file]" << std::endl;
        std::cout << "\nReconstructs a surface from an oriented point cloud using Hermite RBF." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/sphere_coarse.obj" << std::endl;
        std::cout << "\nDisplays the reconstructed isosurface with the target surface overlay." << std::endl;
