...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nPolyhedral Mesh Generation" << std::endl;
        std::cout << "==========================" << std::endl;
        std::cout << "Usage: polyhedral_mesh_generation [surface_mesh_file]" << std::endl;
        std::cout << "\nGenerates tetrahedral and polyhedral (Voronoi) meshes from a surface." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/3holes.obj" << std::endl;
        std::cout << "\nDisplays three meshes: input surface, tetrahedral volume, and dual polyhedral mesh." << std::endl;
