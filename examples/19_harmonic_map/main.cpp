...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nHarmonic Map" << std::endl;
        std::cout << "============" << std::endl;
        std::cout << "Usage: harmonic_map [mesh_file]" << std::endl;
        std::cout << "\nComputes a harmonic map from a 3D surface to a 2D parametric domain." << std::endl;
        std::cout << "Maps mesh boundary to a unit circle. Displays both 3D and 2D views." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/Laurana.obj" << std::endl;
