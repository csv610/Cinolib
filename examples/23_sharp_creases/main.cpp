...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nSharp Creases" << std::endl;
        std::cout << "=============" << std::endl;
        std::cout << "Usage: sharp_creases [mesh_file]" << std::endl;
        std::cout << "\nInteractive tool for marking and exporting sharp crease edges on meshes." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/cube_minus_sphere.obj" << std::endl;
        std::cout << "\nControls: SHIFT+CLICK to toggle crease marking, use GUI for creases and export." << std::endl;
