...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nHomotopy Basis" << std::endl;
        std::cout << "==============" << std::endl;
        std::cout << "Usage: homotopy_basis [mesh_file] [root_vertex_id]" << std::endl;
        std::cout << "\nComputes a shortest homotopy basis for a surface mesh." << std::endl;
        ...
        std::cout << "\nVisualization shows basis loops, spanning tree, and cotree." << std::endl;
