...
int main(int argc, char **argv)
{
    ...
    if(argc==2 && std::string(argv[1])=="-h")
    {
        ...
        std::cout << "================" << std::endl;
        std::cout << "Usage: Poisson_sampling" << std::endl;
        std::cout << "\nGenerates Poisson disk samples in 2D and 3D." << std::endl;
        std::cout << "Use the slider to adjust the sampling radius." << std::endl;
        std::cout << "\nDisplays two windows: 2D sampling in unit square, 3D sampling in unit cube." << std::endl;
