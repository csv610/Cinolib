...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nSphere Sampling" << std::endl;
        std::cout << "===============" << std::endl;
        std::cout << "Usage: sphere_sampling" << std::endl;
        std::cout << "\nGenerates uniform point samples on a sphere." << std::endl;
        std::cout << "Use the slider to adjust the number of sample points (100-10000)." << std::endl;
