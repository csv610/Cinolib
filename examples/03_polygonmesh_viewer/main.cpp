...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nPolygonmesh Viewer" << std::endl;
        std::cout << "==================" << std::endl;
        std::cout << "Usage: polygonmesh_viewer [mesh_file]" << std::endl;
        std::cout << "\nLoads and displays a polygon mesh with interactive GUI controls." << std::endl;
