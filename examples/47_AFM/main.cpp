...
int main(int argc, char **argv)
{
    ...
    {
        std::cout << "\nAFM (Authomatic Flow Maker)" << std::endl;
        std::cout << "===========================" << std::endl;
        std::cout << "Usage: AFM [mesh_file] [logfile] [domain]" << std::endl;
        std::cout << "\nAuthomatic parameterization method for simply connected surfaces." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/hele_shaw.obj" << std::endl;
        std::cout << "\nBatch mode: provide logfile and domain (0=circle,1=square,2=star)." << std::endl;
        std::cout << "Interactive mode: SPACE to step, SHIFT+SPACE to run to convergence." << std::endl;
