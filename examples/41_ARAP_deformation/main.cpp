...
int main(int argc, char *argv[])
{
    ...
    {
        std::cout << "\nARAP Deformation" << std::endl;
        std::cout << "===============" << std::endl;
        std::cout << "Usage: ARAP_deformation [mesh_file]" << std::endl;
        std::cout << "\nInteractive ARAP (As-Rigid-As-Possible) mesh deformation." << std::endl;
        std::cout << "If no mesh file is provided, defaults to: " << DATA_PATH << "/cactus.off" << std::endl;
        std::cout << "\nControls:" << std::endl;
        std::cout << "  SHIFT+CLICK (in Add mode) to add handle" << std::endl;
        std::cout << "  SHIFT+CLICK (in Move mode) to move selected handle" << std::endl;
        std::cout << "  SPACE to compute ARAP deformation" << std::endl;
